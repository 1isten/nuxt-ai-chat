...
export type DonutChartUIToolInvocation = UIToolInvocation<typeof donutChartTool>;

export const donutChartTool = tool({
  description: [
    'Create a DONUT or PIE chart to show PROPORTIONS of a single whole — i.e. how a total breaks down across a small number of mutually-exclusive categories.',
