...
const categories = (invocation: BarChartUIToolInvocation): Record<string, BulletLegendItemInterface> => {
...
const yAxis = (invocation: BarChartUIToolInvocation): string[] => {
  if (!invocation.output?.series) return [];
  ...
  <div v-if="invocation.state === 'output-available'" class="my-5">
    ...
    <div class="relative overflow-hidden">
      ...
      <BarChart
        ...
        :orientation="invocation.output.horizontal ? Orientation.Horizontal : Orientation.Vertical"
